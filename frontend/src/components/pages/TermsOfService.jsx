        ...
        <div className="min-h-screen bg-canvas-soft text-ink overflow-x-hidden selection:bg-primary selection:text-on-primary font-sans">
            ...
            <main className="relative z-10 pt-32 pb-20 container mx-auto px-6">
                ...
                >
                    ...
                    <p className="text-ink-muted mb-8">{t('terms.last_updated')}</p>
                    ...
                    <div className="space-y-8 text-ink-secondary leading-relaxed">
                        <section className="bg-surface p-8 rounded-lg border border-hairline">
                            <h2 className="text-2xl font-bold text-ink mb-4 tracking-tight">{t('terms.section1_title')}</h2>
                            <p>
                        ...
                        <section className="bg-surface p-8 rounded-lg border border-hairline">
                            <h2 className="text-2xl font-bold text-ink mb-4 tracking-tight">{t('terms.section2_title')}</h2>
                            <p>
                        ...
                        <section className="bg-surface p-8 rounded-lg border border-hairline">
                            <h2 className="text-2xl font-bold text-ink mb-4 tracking-tight">{t('terms.section3_title')}</h2>
                            <p>
                        ...
                        <section className="bg-surface p-8 rounded-lg border border-hairline">
                            <h2 className="text-2xl font-bold text-ink mb-4 tracking-tight">{t('terms.section4_title')}</h2>
                            <p>
