    ...
    <div className="flex flex-col h-full">
      <div className="flex-grow flex flex-col items-center justify-center p-2 sm:p-3 md:p-4">
        <div className="w-full max-w-6xl px-2 sm:px-4">
          ...
          {embedUrl ? (
            <div className="aspect-video bg-surface rounded-lg sm:rounded-xl overflow-hidden border border-hairline shadow-[var(--shadow-level-1)]">
              <iframe
                src={embedUrl}
            ...
            <div className="aspect-video bg-surface rounded-lg sm:rounded-xl overflow-hidden border border-hairline shadow-[var(--shadow-level-1)]">
              <div className="w-full h-full flex flex-col items-center justify-center bg-canvas-soft">
                <div className="text-center p-4 sm:p-6">
                  <div className="mx-auto w-12 h-12 sm:w-16 sm:h-16 bg-primary rounded-full flex items-center justify-center mb-3 sm:mb-4">
                  ...
                  <h3 className="text-lg sm:text-xl font-semibold text-ink mb-2">Google Slides Presentation</h3>
                  <p className="text-sm sm:text-base text-ink-muted mb-4">No presentation URL configured</p>
                </div>
              </div>
            </div>
          )}
        ...
        <div className="flex justify-between items-center">
          ...
          <div className="flex items-center space-x-4">
            <div className="flex items-center">
              ...
              <span className="text-ink-muted ml-1">views</span>
            </div>
          </div>
        </div>
      </div>
