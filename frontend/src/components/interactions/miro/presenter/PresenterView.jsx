...
const MiroPresenterView = ({ slide, responses = [] }) => {
  ...
  return (
    <div className="flex flex-col h-full">
            ...
            <div className="aspect-video bg-surface rounded-xl overflow-hidden border border-hairline shadow-[var(--shadow-level-1)]">
              <div className="w-full h-full flex flex-col items-center justify-center bg-canvas-soft">
                <div className="text-center p-6">
                  <div className="mx-auto w-16 h-16 bg-accent-purple-deep rounded-full flex items-center justify-center mb-4">
                  ...
                  <h3 className="text-xl font-semibold text-ink mb-2">Miro Board Interaction</h3>
                  <p className="text-ink-muted mb-4">Click below to open the Miro board in a new tab</p>
                  <a
                    href={miroUrl}
                    target="_blank"
                    rel="noopener noreferrer"
                    className="inline-flex items-center px-6 py-3 bg-primary hover:bg-primary-active text-on-primary font-medium rounded-full transition duration-200"
                  >
                    Open Miro Board
            ...
            <div className="aspect-video bg-surface rounded-xl overflow-hidden border border-hairline shadow-[var(--shadow-level-1)]">
              <div className="w-full h-full flex flex-col items-center justify-center bg-canvas-soft">
                <div className="text-center p-6">
                  ...
                  <h3 className="text-xl font-semibold text-ink mb-2">Miro Board Interaction</h3>
                  <p className="text-ink-muted mb-4">No Miro board URL configured</p>
                </div>
              </div>
            </div>
          )}
      ...
      <div className="bg-surface border-t border-hairline p-4">
        <div className="flex justify-between items-center">
          ...
          <div className="flex items-center space-x-4">
            <div className="flex items-center">
              <div className="w-3 h-3 bg-accent-teal rounded-full mr-2"></div>
              <span className="text-ink font-medium">{responses.length}</span>
              <span className="text-ink-muted ml-1">interactions</span>
            </div>
          </div>
        </div>
      </div>
