...
const PickAnswerPresenterView = ({
  ...
  return (
    <div className="space-y-6 sm:space-y-8">
      <div className="bg-surface rounded-2xl sm:rounded-3xl border border-hairline shadow-[var(--shadow-level-2)] p-6 sm:p-8">
        <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4 sm:gap-6">
          <div>
            ...
            <p className="text-xs sm:text-sm text-ink-muted mt-2 flex items-center gap-1">
              <BarChart2 className="h-4 w-4" />
              {t('slide_editors.pick_answer.live_results_updating')}
            </p>
          </div>

          <div className={`px-4 py-3 rounded-2xl border border-hairline bg-canvas-soft text-ink-muted flex flex-col items-start gap-1 min-w-[12rem]`}>
