  ...
  return (
    <div className="space-y-6">
      <div className="bg-surface rounded-lg p-6 border border-hairline">
        <h3 className="text-xl font-semibold text-ink mb-4">PowerPoint Presentation</h3>
        ...
        <div className="mb-6">
          ...
          <div className="aspect-video bg-canvas-soft rounded-lg flex items-center justify-center border border-hairline">
            <div className="text-center">
              ...
              <p className="text-ink-muted">PowerPoint Presentation</p>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
          ...
          <div className="bg-canvas-soft p-4 rounded-lg border border-hairline">
            <div className="text-2xl font-bold text-accent-orange">PowerPoint</div>
            <div className="text-sm text-ink-muted">File Type</div>
          </div>
          <div className="bg-canvas-soft p-4 rounded-lg border border-hairline">
            <div className="text-2xl font-bold text-primary">Presentation</div>
            <div className="text-sm text-ink-muted">Content Type</div>
          </div>
        </div>
      </div>
    </div>
