  ...
  return (
      ...
      >
        <motion.div
          ...
          className="w-full max-w-md bg-surface border border-hairline rounded-xl shadow-[var(--shadow-level-2)] p-8 relative overflow-hidden"
        >
          <div className="absolute top-0 left-0 w-full h-1 bg-primary" />

          <h2 className="text-2xl font-bold text-ink mb-2">{t('join_presentation.join_presentation_title')}</h2>
          <p className="text-ink-muted mb-8">{t('join_presentation.enter_access_code')}</p>
          ...
          <div className="space-y-6">
            <input
              ...
              maxLength={6}
              className="w-full px-4 py-4 text-center text-3xl font-mono tracking-[0.5em] bg-surface border-2 border-[#dddddd] rounded-xs focus:outline-none focus:border-primary focus:shadow-[var(--shadow-level-1)] text-ink placeholder-ink-faint transition-all"
              autoFocus
            />
            ...
            <div className="flex gap-4">
              <button
                ...
                className="flex-1 px-4 py-3 bg-surface text-ink border border-hairline hover:bg-canvas-soft rounded-md transition-colors font-medium"
              >
              ...
              <button
                ...
                className="flex-1 px-4 py-3 text-on-primary bg-primary hover:bg-primary-active disabled:opacity-50 disabled:cursor-not-allowed rounded-full transition-all font-bold"
              >
...
export const JoinPresentationBtn = ({ onClick, variant }) => {
    ...
    const LandingBtn = "w-full sm:w-auto px-8 py-4 rounded-full bg-primary hover:bg-primary-active font-bold text-lg text-on-primary transition-all flex items-center justify-center gap-2 group";
    const DashBoardBtn = "w-full md:w-auto bg-primary hover:bg-primary-active text-on-primary font-bold px-6 py-3 rounded-full transition-all flex items-center justify-center gap-2"
    return (
       <button
