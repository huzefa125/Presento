...
const TEMPLATES = [
  {
    ...
    slides: [
      ...
      { type: 'instruction', title: 'Quiz leaderboard', question: 'Top Quiz participants will be displayed here' },
      { type: 'word_cloud', title: 'Describe our team culture in 1 word', question: 'Describe our team culture in 1 word' },
  ...
  },
  {
    ...
    previewType: 'word_cloud',
    slides: [
      { type: 'instruction', title: 'Fun meeting icebreakers', question: 'Welcome! Grab your phone and join in' },
      { type: 'word_cloud', title: 'If last month was a theme park ride, which one would it be?', question: 'If last month was a theme park ride, which one would it be?' },
      ...
      { type: 'multiple_choice', title: 'Where would you rather be right now?', question: 'Where would you rather be right now?', options: ['Sunny Beach', 'Mountain Cabin', 'Cozy Home', 'Office Coffee Shop'] },
    ],
  },
  {
    ...
    slides: [
      ...
      { type: 'word_cloud', title: 'What is top of mind for you today?', question: 'What is top of mind for you today?' },
  ...
  },
  {
    ...
    slides: [
      ...
      { type: 'word_cloud', title: 'What is the most important trait of a leader?', question: 'What is the most important trait of a leader?' },
  ...
  },
  {
    ...
    slides: [
      ...
      { type: 'multiple_choice', title: 'What is your preferred method of learning?', question: 'What is your preferred method of learning?', options: ['Hands-on Practice', 'Video Tutorials', 'Group Discussion', 'Reading Docs'] },
